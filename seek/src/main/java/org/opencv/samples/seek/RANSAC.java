...
public class RANSAC
{
    ...
    public static List<Double> perform(List<Double> data_Y, List<Double> data_X ,int num, int iter, double threshDist, double inlierRatio)
    {
